...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "HelpicoNetwork") type = HelpicoNetwork;
    if(strType == "HelpicoNetworkVariable") type = HelpicoNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == HelpicoNetwork) s = "HelpicoNetwork";
    if(type == HelpicoNetworkVariable) s = "HelpicoNetworkVariable";
