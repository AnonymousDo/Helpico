...
#define BOOST_TEST_MODULE Helpico Test Suite

#include "test_helpico.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_helpico_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
