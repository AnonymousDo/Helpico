    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("drkblue"), QVariant("drkblue"));
    ui->theme->addItem(QString("HELPICO-original"), QVariant("drkblue"));
    ui->theme->addItem(QString("HELPICO-traditional"), QVariant("trad"));
