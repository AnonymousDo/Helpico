    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Helpico Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Helpico address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and helpico: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Helpico Core"), this);
    aboutAction->setStatusTip(tr("Show information about Helpico Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Helpico Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Helpico addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Helpico addresses"));
    ...
    openAction->setStatusTip(tr("Open a helpico: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Helpico Core help message to get a list with possible Helpico Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Helpico Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Helpico network", "", count));
    } else {
...
{
    QString strTitle = tr("Helpico Core"); // default title
