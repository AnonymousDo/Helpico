    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("Helpico Core");
    ...
    QString copyrightTextHelpico   = QChar(0xA9)+QString(" 2018 ").arg(COPYRIGHT_YEAR) + QString(tr("The Helpico Core developers"));
    ...
    }else if (GUIUtil::getThemeName() == "helpico-dark"){
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextHelpico);
