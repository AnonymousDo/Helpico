...
Only requiring some minor changes is helpico.cpp.
...
Changes to helpico.cpp
----------------------
helpico.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
