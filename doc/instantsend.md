...
This mechanism has been integrated into Bitcore-Node-Helpico which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/helpico/insight-api-helpico#web-socket-api](https://github.com/helpico/insight-api-helpico#web-socket-api)
* API: [https://github.com/helpico/insight-api-helpico#instantsend-transactions](https://github.com/helpico/insight-api-helpico#instantsend-transactions)
...
By default, the Helpico Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Helpico Core daemon:
