...
* Update translations, see [translation_process.md](https://github.com/AnonymousDo/Helpico/blob/master/doc/translation_process.md#syncing-with-transifex)
...
### Build and sign Helpico Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit helpico=v${VERSION} ../helpico/contrib/gitian-descriptors/gitian-osx.yml
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [helpico-detached-sigs](https://github.com/AnonymousDo/Helpico-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Helpico-development mailing list
