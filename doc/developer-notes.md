...
Helpico Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Helpico Core, where everyone uses
...
pay attention to for reviewers of Helpico Core code.

General Helpico Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Helpico Core uses tinyformat, which is type safe. Leave them out to avoid confusion
